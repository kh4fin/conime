          ...
          <>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
              {recentAnime.map((anime) => (
                <AnimeCard key={anime.batchId} anime={anime} />
              ))}
            </div>
            {recentTotalPages > 1 && (
              <div className="mt-4">
